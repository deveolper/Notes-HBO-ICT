...
De student ontwerpt en ontwikkelt, zowel individueel als in een groepssetting een volledige datastraat met behulp van bestaande componenten en zelf uitgewerkte scripts op basis van gegeven informatiebehoeften enerzijds en beschikbare data anderzijds.
...
- **Aanwezigheid:** Hoe vaak ben je er?
...
Feed** moeten we ook aan elkaar geven.

Beoordeling is met datapunten. Die worden altijd met de student besproken, de datapunten geven geen cijfer. In DEDS werken ze met datapunten, niet met cijfers.

Alle datapunten vormen gezamenlijk een eindoordeel.

De opdrachten in DEDS-praktica maak je in DUO's, in diezelfde duo's heb je de gesprekken. De projecten zijn in groepjes van 4, maar de beoordeling is individueel.

# Leercoaching
## Hoofddoel
In de loop va de opleiding groeien naar een zelflerende professional.
## Subdoelen
- Begeleid de student in het **reflecteren** op leerpresetaties met **STARRT**
- Begeleid de student in het **ontwikkelen** van goede **professionele en studiehouding**
- Begeleid de student in het **ontwikkelen** van **feedback- en intervisievaardigheden**

# Info
- 4 datapunt-feedback momenten staan al ingeroosterd.
- In DUO's met een DEDS portofolio gesprek met een docent die niet van jouw klas is, krijg je een gesprek over wat je hebt geleerd van het maken van de DEDS-opdrachten.

# Q & A
## Is een clustering-model een classificatie-model?
Nee. Een clustering-model is geen classificatie-model, bij een classificatie-model zie je het goede antwoord op basis van door de mens gemaakte groepen. Bij een clustering-model maakt de computer zelf de groepen.
## Wat als je niet genoeg studiepunten hebt om stage te volgen?
Dan ga je een minor volgen.
## Krijgen we een OV, V, G ipv een cijfer?
Nee, je krijgt voor elk datapunt een cijfer. Een rode, een geel/oranje of een groen.
## Wat is er mis met een OV, V, G ipv een cijfer?
Die termen worden losgelaten omdat het gaat over of het goed gaat, niet over wat het cijfer is.
## Die smileys voelen lagere klas basisschool
De feedback eronder is belangrijker dan de smiley.
## Hoe ziet het portofolio eruit?
Daarvoor moet je Mirabai Vosteen moeten mailen.
## Mag je ook switchen?
Ja. Zelfs elke opdracht, maar dat moet wel iedereen prettig vinden.
## Ben je vrij als je aan het einde van deds een groene smiley hebt?
Ja.
